...
call_active_view_show(struct Window *win, GHashTable *options)
{
	...
	evas_object_smart_callback_add(data->bt_call_state, "clicked", call_button_state_clicked, data);
	...
	evas_object_smart_callback_add(data->bt_keypad, "clicked", call_button_dtmf_clicked, data);
...
static void
call_button_sound_state_clicked(struct CallActiveViewData *data, Evas_Object *obj, void *event_info)
{
...
void
call_button_state_clicked(struct CallActiveViewData *data, Evas_Object *obj, void *event_info)
{
